...
namespace ENW.Classes.Horses
{
    ...
    internal class BionicHorse : GenericHorse
    {
        ...
        public BionicHorse(string name, string color, int stamina, int strength, int speed, int dexterity, int strikes, int streetCred, bool isAlive, int money, bool ironLungs, bool assBlaster3000, bool absoluteUnit, bool springLegs, bool totemOfUndying) : base(name, color, stamina, strength, speed, dexterity, strikes, streetCred, isAlive)
        {
